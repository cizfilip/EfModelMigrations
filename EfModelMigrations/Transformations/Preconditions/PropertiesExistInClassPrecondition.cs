...
{
    public class PropertiesExistInClassPrecondition : ModelTransformationPrecondition
    {
        private string className;
        private string[] properties;

        public PropertiesExistInClassPrecondition(string className, string[] properties)
        {
