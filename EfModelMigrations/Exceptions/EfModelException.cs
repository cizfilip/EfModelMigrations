...
namespace EfModelMigrations.Exceptions
{
    ...
    public class EfModelException : Exception
    {
        ...
        public EfModelException(string message)
            : base(message)
        {
        }
        ...
        public EfModelException(string message, Exception innerException)
        ...
        /// </param>
        protected EfModelException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
